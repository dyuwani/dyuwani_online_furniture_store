  ...
  return (
    <div className="sign-up-container">
      ...
      <div className="sign-up-navbar">
        <header
          data-role="Header"
          className="sign-up-header max-width-container"
        >
          <div className="sign-up-navbar1">
            ...
            <div className="sign-up-middle">
              <div className="sign-up-left">
                <a href="#categories" className="sign-up-shop navbar-link">
                  SHOP
                </a>
                <a href="#lookbook" className="sign-up-lookbook navbar-link">
                  LOOKBOOK
                </a>
                <a
                  href="#trending_items"
                  className="sign-up-special navbar-link"
                >
                  SPECIAL
                </a>
              </div>
              ...
              <div className="sign-up-right">
                ...
                <a href="#blog" className="sign-up-blog navbar-link">
                  BLOG
                </a>
                <a href="#contact" className="sign-up-contact navbar-link">
                  CONTACT
                </a>
              </div>
            </div>
          ...
          <div data-role="MobileMenu" className="sign-up-mobile-menu">
            <div className="sign-up-nav">
              <div className="sign-up-container2">
                <span className="sign-up-logo-center1">MOBILLIO</span>
                <div
              ...
              <div className="sign-up-middle1">
                <span className="sign-up-text">SHOP</span>
                <span className="sign-up-text1">LOOKBOOK</span>
                <span className="sign-up-text2">SPECIAL</span>
                <span className="sign-up-text3">ABOUT</span>
                <span className="sign-up-text4">BLOG</span>
                <span className="sign-up-text5">CONTACT</span>
              </div>
            </div>
            <div>
              <svg
      ...
      <span>It looks like you are new here, sign up using the form below.</span>
      <form name="Email Address" autoComplete="email" className="sign-up-form">
        <div className="sign-up-form1">
          <div className="sign-up-inputs">
            ...
            <input
              ...
              className="input book-input"
            />
            <div className="sign-up-lower">
              <div className="sign-up-button">
                <button className="sign-up-sign-up button button-main">
                  <span className="sign-up-text7">Sign Up</span>
                </button>
              </div>
            </div>
