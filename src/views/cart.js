  ...
  return (
    <div className="cart-container">
      ...
      <div className="cart-navbar">
        <header data-role="Header" className="cart-header max-width-container">
          <div className="cart-navbar1">
            <div className="cart-container1">
              ...
              <input
                type="text"
                placeholder="search"
                className="cart-input input"
              />
            </div>
            <div className="cart-middle">
              <div className="cart-left">
                <a href="#categories" className="cart-shop navbar-link">
                  SHOP
                </a>
                <a href="#lookbook" className="cart-lookbook navbar-link">
                  LOOKBOOK
                </a>
                <a href="#trending_items" className="cart-special navbar-link">
                  SPECIAL
                </a>
              </div>
              ...
              <div className="cart-right">
                ...
                <a href="#blog" className="cart-blog navbar-link">
                  BLOG
                </a>
                <a href="#contact" className="cart-contact navbar-link">
                  CONTACT
                </a>
              </div>
            </div>
            <div className="cart-icons">
              ...
              <img
                ...
                className="cart-image3"
              />
            </div>
          </div>
          <div data-role="BurgerMenu" className="cart-burger-menu">
          ...
          <div data-role="MobileMenu" className="cart-mobile-menu">
            <div className="cart-nav">
              <div className="cart-container2">
                <span className="cart-logo-center1">MOBILLIO</span>
                <div
                  data-role="CloseMobileMenu"
                  className="cart-close-mobile-menu"
                >
              ...
              <div className="cart-middle1">
                <span className="cart-text">SHOP</span>
                <span className="cart-text1">LOOKBOOK</span>
                <span className="cart-text2">SPECIAL</span>
                <span className="cart-text3">ABOUT</span>
                <span className="cart-text4">BLOG</span>
                <span className="cart-text5">CONTACT</span>
              </div>
            </div>
            <div>
              <svg viewBox="0 0 950.8571428571428 1024" className="cart-icon04">
              ...
              <svg viewBox="0 0 877.7142857142857 1024" className="cart-icon06">
              ...
              <svg viewBox="0 0 602.2582857142856 1024" className="cart-icon08">
