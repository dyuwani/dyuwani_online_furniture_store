  ...
  return (
    <div className="login-container">
      ...
      <div className="login-navbar">
        <header data-role="Header" className="login-header max-width-container">
          <div className="login-navbar1">
            ...
            <div className="login-middle">
              <div className="login-left">
                <a href="#categories" className="login-shop navbar-link">
                  SHOP
                </a>
                <a href="#lookbook" className="login-lookbook navbar-link">
                  LOOKBOOK
                </a>
                <a href="#trending_items" className="login-special navbar-link">
                  SPECIAL
                </a>
              </div>
              ...
              <div className="login-right">
                ...
                <a href="#blog" className="login-blog navbar-link">
                  BLOG
                </a>
                <a href="#contact" className="login-contact navbar-link">
                  CONTACT
                </a>
              </div>
            </div>
          ...
          <div data-role="MobileMenu" className="login-mobile-menu">
            <div className="login-nav">
              <div className="login-container2">
                <span className="login-logo-center1">MOBILLIO</span>
                <div
                  data-role="CloseMobileMenu"
                  className="login-close-mobile-menu"
                >
              ...
              <div className="login-middle1">
                <span className="login-text">SHOP</span>
                <span className="login-text1">LOOKBOOK</span>
                <span className="login-text2">SPECIAL</span>
                <span className="login-text3">ABOUT</span>
                <span className="login-text4">BLOG</span>
                <span className="login-text5">CONTACT</span>
              </div>
            </div>
            <div>
              <svg
      ...
      <div className="login-inputs">
        <span>We&apos;re ready to take your order.</span>
        <input
          type="text"
        ...
        <div className="login-lower">
          <div className="login-button">
            <button className="login-sign-up button button-main">
              <span className="login-text7">Sign Up</span>
            </button>
          </div>
        </div>
